...
For the first set of random number the error in the value of Pi is larger than the error in value of Pi in the second set of random numbers. So the second one is better than the first one.
*/